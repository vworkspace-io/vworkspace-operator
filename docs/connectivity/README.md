...
3. [push-mode.md](push-mode.md) — When the control plane writes CRDs directly via the K8s API.
4. [gitops-mode.md](gitops-mode.md) — the control plane renders manifests to Git; the cluster's Flux or Argo CD syncs them.
