...
Published on every `v*` git tag ([release process](../development/release-process.md)). Replace `0.0.7` with the version you are installing ([releases page](https://github.com/vworkspace-io/vworkspace-operator/releases)).
